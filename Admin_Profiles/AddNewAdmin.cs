    ...
    public partial class AddNewAdmin : Form
    {
        ...
        private void submitButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd3 = new SqlCommand("ecommerce.sp_Create_Admin", con);
                ...
                MessageBox.Show("You have added a new admin!", "Successful Operation", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
